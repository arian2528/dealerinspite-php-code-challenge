...
<head>
    ...
    {{-- contact form CSS --}}
    <link href="css/contact-us-form.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCr3p5GFi6KGuiWTG5maAKQsKgmCpj24z4&sensor=false"></script>
